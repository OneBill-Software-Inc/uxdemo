  ...
  return (
    <Icon className={stroke ?? 'stroke-primary'} {...rest}>
      ...
      <path
        ...
        d="M18.5 15.8a9.1 9.1 0 0 1 4 4c0 .5-.3 1-.7 1.1l-.8.1m-4.5-9.5a4.5 4.5 0 0 0 0-8m-2 4a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0ZM3.1 18.9C4.7 16.5 7 15 10 15c2.8 0 5.3 1.5 7 4 .3.5.5.7.4 1 0 .3-.1.6-.4.8-.2.2-.6.2-1.3.2H4.3c-.7 0-1 0-1.3-.2-.3-.2-.4-.5-.4-.7 0-.4.1-.6.5-1.2Z"
      />
    </Icon>
  )
}
