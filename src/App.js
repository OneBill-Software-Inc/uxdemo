...
const navigation = [
  ...
  { name: 'Charge Groups', href: '#' },
  { name: 'Event Groups', href: '#' },
  { name: 'Day and Time Classification', href: '#' },
]
  ...
  return (
    <div className="isolate bg-white">
      ...
      <div className="px-6 pt-6 lg:px-8">
        <div>
          <nav className="flex h-9 items-end justify-between" aria-label="Global">
            <div className="flex lg:min-w-0 lg:flex-1" aria-label="Global">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">OneBill</span>
                <img className="h-8" src="https://www.onebillsoftware.com/wp-content/uploads/2021/12/OneBill-Logo.png" alt="" />
              </a>
            </div>
            ...
            <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
              {navigation.map((item) => (
                <a key={item.name} href={item.href} className="font-semibold text-gray-900 hover:text-gray-900 whitespace-nowrap">
                  {item.name}
                </a>
              ))}
            </div>
